...
function validateField(fieldName, fieldValue) {
  ...
  if (fieldName === "username") {
    if (!fieldValue) {
      showFieldError(fieldName, "El nombre de usuario es obligatorio");
    } else if (!isValidName(fieldValue)) {
      showFieldError(fieldName, "Formato de nombre inválido");
    } else if (!isValidNameNumber(fieldValue)) {
      showFieldError(fieldName, "El nombre de usuario no puede tener más de 15 letras");
    }
  }
  ...
  if (fieldName === "last_name") {
    if (!fieldValue) {
      showFieldError(fieldName, "El apellido es obligatorio");
    } else if (!isValidName(fieldValue)) {
      showFieldError(fieldName, "Formato de apellido inválido");
    } 
  }
  ...
  if (fieldName === "password1") {
    if (!fieldValue) {
      showFieldError(fieldName, "La contraseña es obligatoria");
...
// Función para limitar a 15 caracteres
function isValidNameNumber(content) {
